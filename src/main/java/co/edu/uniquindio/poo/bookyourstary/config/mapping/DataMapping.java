    ...
    public static void createAllHostings() {
        try {
            ...
            MainController.getInstance().getHostingService().createHouse(
                    ...
                    LocalDate.now(), LocalDate.now().plusDays(30)); // No creamos apartamentos aquí - lo haremos desde
                                                                    // App.java usando ApartmentCreator
            System.out.println("La creación de apartamentos será manejada por ApartmentCreator");
