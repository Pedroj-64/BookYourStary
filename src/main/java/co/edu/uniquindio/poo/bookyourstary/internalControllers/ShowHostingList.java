    ...
    public static void showHostings(List<Hosting> hostings,
        ...
        for (int i = 0; i < imageViews.size(); i++) {
            if (i < hostings.size()) {
                ...
                Image image = co.edu.uniquindio.poo.bookyourstary.util.ImageHandler.loadImage(hosting.getImageUrl());
                ...
                imageViews.get(i).setImage(co.edu.uniquindio.poo.bookyourstary.util.ImageHandler.loadImage(null));
