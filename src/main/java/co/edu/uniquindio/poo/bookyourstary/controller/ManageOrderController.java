...
public class ManageOrderController {
    ...
    /**
     * Crea y confirma las reservas para todos los hostings en el carrito, usando el
     * cliente en sesión.
    ...
    /**
     * Devuelve una lista de precios (uno por hosting pendiente) para el rango de
     * fechas dado,
            ...
            return hostings.stream()
                    .map(h -> {
                        ...
                        try {
                            ...
                            System.err
                                    .println("Error al aplicar descuentos para " + h.getName() + ": " + e.getMessage());
    ...
    /**
     * Generates a summary of discounts applied to each pending hosting and displays
     * it in the TextArea.
    ...
    /**
     * Confirms a booking for a single hosting, removing it from the cart if
     * successful.
    ...
    public boolean confirmSingleBooking(Hosting hosting, LocalDate startDate, LocalDate endDate, int numberOfGuests) {
        ...
        try {
            ...
            // Success alert will be handled by the ViewController, this method just returns
            // status
            return true;
     ...
     */
    public void initializeDefaultValues(DatePicker datePicker_inicio, DatePicker datePicker_fin,
            TextField txt_numHuespedes) {
