...
public class TemplateLoader {
    ...
    // Método auxiliar para verificar y listar los recursos disponibles (útil para depuración)
    ...
    private static String generateEmergencyTemplate(String templateName) {
        if ("activateAccount.html".equals(templateName)) {
            ...
            return "<!DOCTYPE html><html><body><h1>Plantilla de emergencia</h1><p>Esta es una plantilla generada automáticamente porque no se pudo encontrar: " + templateName + "</p></body></html>";
        }
    }
}
