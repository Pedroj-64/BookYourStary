...
public class CreateAdmin {
    /**
     * Crea y registra un administrador completamente funcional usando singletons de repositorio y servicio.
     ...
     */
    public static Admin createAndRegisterAdmin(String id, String name, String phoneNumber, String email, String password) {
