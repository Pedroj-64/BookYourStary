 ...
 * Centraliza la lógica de descuentos para que pueda ser reutilizada en varios controladores.
 */
public class DiscountManager {
     ...
     */
    public Map.Entry<Offer, Double> getBestOfferWithPrice(Hosting hosting, LocalDate startDate, LocalDate endDate) {
