...
public class CreationAndEditingFormViewController {
    ...
    void initialize() {
        ...
        // Establecer los campos del formulario basados en el alojamiento a editar (si
        // existe)
    ...
    public void setAllFieldsFromHosting() {
        ...
        // Al configurar campos para un alojamiento existente, borrar cualquier ruta de
        // imagen seleccionada previamente
        ...
        try {
            ...
            // Si hostingToEdit tiene una imagen, setFormFieldsFromHosting en el controlador
            // lógico la cargará en imgFoto.
            // selectedImagePath será null inicialmente para las ediciones, lo que significa
            // "mantener la imagen actual" a menos que se elija una nueva.
